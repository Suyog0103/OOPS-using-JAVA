...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	@Override
	public Employee findById(int id) {             //index of calls equals method and if it returns true then index of returns index of that object
		int pos=elist.indexOf(new Employee(id));   //here equals method in employee is called because
		if(pos!= -1) {                             //index of has inbuilt equals method and we have t overwrite it to compare only id of it
	...
	public boolean removeById(int id) {
		return elist.remove(new Employee(id));  //remove returns true if
	}
